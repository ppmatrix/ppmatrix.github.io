...
Now we will create the our script to output the content of password file to a file in our temporary directory. After that we will send the script to the directory referenced in the cronjob script which is wiped out each minute:
