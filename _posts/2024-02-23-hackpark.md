...
Now as pointed on Q5 we must use this service to get the user flag on Jeffs Desktop. We know the WindowsScheduler is periodically running Message.exe with root privilege. So we will generate a payload with msvenom to make our own Message.exe.
